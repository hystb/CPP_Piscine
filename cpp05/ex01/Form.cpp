...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/25 17:13:38 by nmilan            #+#    #+#             */
/*   Updated: 2023/12/08 12:46:16 by nmilan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(const Form& src) : _name(src.getName()), _rank_to_sign(src.getRankToSign()), _rank_to_use(src.getRankToUse()){
